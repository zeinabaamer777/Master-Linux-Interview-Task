...
$(document).ready(function () {
    ...
    function chartjs_one() {
        ...
        new Chart(element, {
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: 'Transactions Month to date'
                }
            }
        });
    }
    ...
    function chartjs_three() {
        ...
        new Chart(element, {
            type: 'pie',
            data: {
                labels: ["Direct 5%", "Social 6%", "Other", "Paid 8%", "Organic-Search 5%"],
                datasets: [{
                    label: "Population (millions)",
                    backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850"],
                    data: [929.42,835.49,820.11,358.61,334.09]
                }]
            },
            options: {
                title: {
